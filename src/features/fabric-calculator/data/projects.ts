// features/fabric-yardage/data/projects.ts

import { ProjectId, ProjectOption, SizeId, SleeveId } from "../types";
...
/**
 * Generate simple projects using one base value.
 */
...
export const PROJECTS: ProjectOption[] = Object.entries(PROJECT_DATABASE).map(
  ([id, project]) => ({
